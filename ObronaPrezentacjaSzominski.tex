...
W środowisku zwierząt, obserwuje się podświadomą chęć grupowania osobników w ławice, watahy czy hordy. W większych skupiskach zwierzęta zwiększają swoje szanse na przetrwanie, w początkowym okresie swojego życia. Inny powód łączenia się w grupy, to pozyskiwanie pożywienia. Polowanie w grupie przynosi wymierne korzyści, każdemu z osobników z osobna.
...
\begin{itemize}
	\item Lepsza wydajność przemieszczania się robotów w drzwiach.
	
	\item Algorytm oparty o zasady społeczne sprawdza się znacznie lepiej w skomplikowanych przestrzeniach niż metoda Reciprocal Velocity Obstacles.

...
\begin{itemize}
	\item Ludzi czy zwierząt skutecznie koordynują przemieszczanie się bez jawnej komunikacji. 
...
\note{\footnotesize
	...
	\begin{itemize}
		\item  Pobiera lokalizacje uczestników ruchu (linia: 3),
		...
		\item  Gdy nie koliduje wyznacz najkrtószą trasę do celu.
		\item  Gdy cel osiągnięty zakończ sobie działanie (linia: 16)
		...
		\item W algorytmie \textit{R+} uwzględnia w wyznaczanieu trajektorii ruchu również roboty o niższym \textit{współczynniku respektu}.
